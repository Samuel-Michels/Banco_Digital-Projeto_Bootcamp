...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (isContaEntrarValida){
            ...
            while(isContaEntrarValida){
                ...
                if (decisao != "0"){
                    saldoTotal = calcularSaldoTotalMain(saldoContaCorrente,saldoChequeEspecial);
                }
                ...
                switch (decisao){
                    case "1":
                        // TODO: 10/10/2022 fazer interface de extrato
                        break;
    ...
    public static Double calcularSaldoTotalMain(Double saldoContaCorrente, Double saldoChequeEspecial){
        Double saldoTotal = saldoContaCorrente + saldoChequeEspecial;
